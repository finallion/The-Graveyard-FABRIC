...
public class HauntedHouseStructure extends StructureFeature<StructurePoolFeatureConfig> {
    private static final int SIZE = 30;

    public HauntedHouseStructure(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, (context) -> {
                    if (!HauntedHouseStructure.canGenerate(context)) {
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(() -> HauntedHouseGenerator.STARTING_POOL, 10);
