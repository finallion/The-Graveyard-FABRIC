...
public class SmallSavannaGraveStructure extends StructureFeature<StructurePoolFeatureConfig> {
    private static final int SIZE = 4;

    public SmallSavannaGraveStructure(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, (context) -> {
                    if (!SmallSavannaGraveStructure.canGenerate(context)) {
                        return Optional.empty();
                    }
                    else {
                        return SmallSavannaGraveStructure.createPiecesGenerator(context);
                    }
                },
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(() -> SmallSavannaGraveStructure.SmallSavannaGraveGenerator.STARTING_POOL, 10);
