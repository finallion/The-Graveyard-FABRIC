...
public class SmallGraveStructure extends StructureFeature<StructurePoolFeatureConfig> {
    private static final int SIZE = 4;


    public SmallGraveStructure(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, (context) -> {
                    if (!SmallGraveStructure.canGenerate(context)) {
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(() -> SmallGraveStructure.SmallGraveGenerator.STARTING_POOL, 10);
