...
public class SmallSpruceTree03 extends BaseSpruceTree {
    ...
    public boolean generate(FeatureContext<TGTreeFeatureConfig> context) {
        ...
        generateTwoStar(context, mutable.add(0, -5, 0), false);
        generateOneStar(context, mutable.add(0, -6, 0), false);
        randomSpreadTwo(context, mutable.add(0, -6, 0), false, 3);
        generateOneStar(context, mutable.add(0, -7, 0), false);
        randomSpreadTwo(context, mutable.add(0, -7, 0), false, 3);
        generateTwoStar(context, mutable.add(0, -8, 0), false);
        generateBranchesOne(context, mutable.add(0, -8, 0), 1);
        randomSpreadTwo(context, mutable.add(0, -9, 0), false, 3);
