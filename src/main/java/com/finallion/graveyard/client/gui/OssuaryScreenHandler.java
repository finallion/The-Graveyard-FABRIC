...
public class OssuaryScreenHandler extends ScreenHandler {
    ...
    public OssuaryScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        ...
        this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
            ...
            public void onTakeItem(PlayerEntity player, ItemStack stack) {
                ...
                OssuaryScreenHandler.this.output.unlockLastRecipe(player);
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, TGBlocks.OSSUARY);
    }
    ...
    void populateResult() {
        if (!this.availableRecipes.isEmpty() && this.isInBounds(this.selectedRecipe.get())) {
            ...
            this.outputSlot.setStack(carvingRecipe.craft(this.input));
        } else {
            this.outputSlot.setStack(ItemStack.EMPTY);
        }
