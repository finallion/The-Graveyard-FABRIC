...
public class TheGraveyardConfig implements Config {
    ...
    @Override
    public void save() {
        biomeConfigEntries.putIfAbsent("haunted_lakes_biome", ConfigBiomeEntry.of(true, 0.7F, 0.15F, 256, 62));
        biomeConfigEntries.putIfAbsent("eroded_haunted_forest_biome", ConfigBiomeEntry.of(true, 0.9F, 0.1F, 256, 62));
        biomeConfigEntries.putIfAbsent("haunted_forest_biome", ConfigBiomeEntry.of(true, 0.5F, 0.15F, 256, 62));
