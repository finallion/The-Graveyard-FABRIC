...
public class TGRecipeTypes {
    ...
    public static RecipeType<OssuaryRecipe> OSSUARY_CARVING = Registry.register(Registry.RECIPE_TYPE, TGRecipeTypes.Type.IDENTIFIER, TGRecipeTypes.Type.INSTANCE);
