...
public class TGEntities {
    ...
    public static final EntityType<GhoulEntity> DECAYING_GHOUL = FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, GhoulEntity::new).dimensions(EntityDimensions.fixed(0.6F, 1.7F)).build();
