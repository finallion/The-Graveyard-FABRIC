...
public class TGConfiguredFeatures {
    ...
    public static PlacedFeature ANCIENT_DEAD_CORAL_REEF_PLACED_FEATURE = ANCIENT_DEAD_REEF_VEGETATION.withPlacement(VegetationPlacedFeatures.modifiers(PlacedFeatures.createCountExtraModifier(15, 0.1F, 1)));
