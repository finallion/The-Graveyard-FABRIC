    ...
    public static void init() {
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "small_walled_graveyard"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_SMALL_WALLED_GRAVEYARD);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "small_walled_graveyard_savanna"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_SMALL_WALLED_GRAVEYARD_SAVANNA);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "small_grave"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_SMALL_GRAVE);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "mushroom_grave"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_MUSHROOM_GRAVE);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "large_birch_tree"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_LARGE_BIRCH_TREE);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "medium_walled_graveyard"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_MEDIUM_WALLED_GRAVEYARD);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "small_walled_graveyard_desert"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_SMALL_WALLED_GRAVEYARD_DESERT);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "large_walled_graveyard"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_LARGE_WALLED_GRAVEYARD);
                        });
        ...
        BiomeModifications.create(new Identifier(TheGraveyard.MOD_ID, "haunted_house"))
                .add(ModificationPhase.ADDITIONS,
                        ...
                        context -> { context.getGenerationSettings().addBuiltInStructure(TGConfiguredStructureFeatures.CONFIGURED_HAUNTED_HOUSE);
                        });
