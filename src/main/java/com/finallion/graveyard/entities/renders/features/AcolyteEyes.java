...
public class AcolyteEyes extends FeatureRenderer<AcolyteEntity, IllagerEntityModel<AcolyteEntity>> {


    public AcolyteEyes(FeatureRendererContext<AcolyteEntity, IllagerEntityModel<AcolyteEntity>> context) {
        super(context);
    }
