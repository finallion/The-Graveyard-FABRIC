...
public class TGBlocks {
    ...
    public static final Supplier<Block> PEDESTAL = RegistryHelper.registerBlock("pedestal", () -> new PedestalBlock(AbstractBlock.Settings.create().strength(1.0F).sounds(BlockSoundGroup.DEEPSLATE)));
    ...
    public static final Supplier<Block> ALTAR_SIDE = RegistryHelper.registerBlock("altar_side", () -> new AltarSideBlock(AbstractBlock.Settings.create().strength(50.0F, 1200.0F).dropsNothing()));
    public static final Supplier<Block> ALTAR_CORNER = RegistryHelper.registerBlock("altar_corner", () -> new AltarCornerBlock(AbstractBlock.Settings.create().strength(50.0F, 1200.0F).dropsNothing()));
    public static final Supplier<Block> ALTAR_CENTER = RegistryHelper.registerBlock("altar_center", () -> new AltarCenterBlock(AbstractBlock.Settings.create().strength(50.0F, 1200.0F).dropsNothing()));
